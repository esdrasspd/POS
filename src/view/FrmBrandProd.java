...
public class FrmBrandProd extends javax.swing.JFrame {
    ...
    private String nombreTabla = "brand_prod";
    ...
    private void initComponents() {
        ...
        fldBrand = new javax.swing.JTextField();
        ...
        jLabel5.setText("MARCA PRODUCTOS");
        ...
        lblBrand.setText("Nombre de marca:");
        getContentPane().add(lblBrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(1200, 130, -1, 30));

        fldBrand.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        fldBrand.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fldBrandActionPerformed(evt);
            }
        });
        getContentPane().add(fldBrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 170, 260, 50));
        ...
        getContentPane().add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(1190, 90, 80, 20));

        jLabel3.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        jLabel3.setText("Id:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 90, -1, -1));

        jLabel15.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel15.setText("Buscar nombre de marca:");
    ...
    private void btnModificarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnModificarMouseClicked
        ...
        int op = JOptionPane.showConfirmDialog(null, "¿Desea actualizar los datos?", "Confirme si desea actualizar", 
    ...
    private void fldBrandActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fldBrandActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fldBrandActionPerformed
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if(fila == -1 ) {
            ...
            String name = (String)jTable1.getValueAt(fila, 1);
            
            fldBrand.setText(name);
            txtId.setText(id);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmBrandProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBrandProd().setVisible(true);
            }
        });
    }
    
    private void agregarCampos(){
        campos.add(fldBrand.getText());
    }
    
    private void vaciarCampos(){
        fldBrand.setText(null);
        txtId.setText(null);
    }
    ...
    private javax.swing.JTextField fldBrand;
