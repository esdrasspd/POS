...
public class FrmMethodPayment extends javax.swing.JFrame {
    ...
    private String nombreTabla = "payment";
    ...
    private void initComponents() {
        ...
        fldPayment = new javax.swing.JTextField();
        ...
        txtCod.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        txtCod.setText("Nombre de forma de pago:");
        getContentPane().add(txtCod, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 130, 220, 30));

        fldPayment.setFont(new java.awt.Font("Roboto", 0, 15)); // NOI18N
        fldPayment.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fldPaymentActionPerformed(evt);
            }
        });
        getContentPane().add(fldPayment, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 170, 270, 50));
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 90, 1090, 420));
        ...
        jLabel15.setText("Buscar por nombre de forma:");
    ...
    private void fldPaymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fldPaymentActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fldPaymentActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMethodPayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMethodPayment().setVisible(true);
            }
        });
    }
    
    private void agregarCampos(){
        campos.add(fldPayment.getText());
    }
    
    private void vaciarCampos(){
        fldPayment.setText(null);
        txtId.setText(null);
    }
    ...
    private javax.swing.JTextField fldPayment;
