...
public class FrmMeasuresProd extends javax.swing.JFrame {
    ...
    private String nombreTabla = "measure_prod";
    private List<String> column = new ArrayList<>();
    private List<String> campos = new ArrayList<>();
    private String id;
    
    private String buscar = "";
    private String campoBuscar = "measure";
    
    
    public FrmMeasuresProd() {
        initComponents();
        
        column.add("Id");
        column.add("Medida del producto");
        
        nombreColumnas.add("measure");
    ...
    private void initComponents() {
        ...
        fldMeasure = new javax.swing.JTextField();
        ...
        setMaximumSize(new java.awt.Dimension(1420, 630));
        setMinimumSize(new java.awt.Dimension(1420, 630));
        setUndecorated(true);
        setResizable(false);
        ...
        lblBrand.setText("Medida del producto (en mts):");
        getContentPane().add(lblBrand, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 180, -1, 30));

        fldMeasure.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        fldMeasure.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                fldMeasureActionPerformed(evt);
            }
        });
        getContentPane().add(fldMeasure, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 210, 260, 50));

        lblCodCatProd.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        lblCodCatProd.setText("Id seleccionado:");
        getContentPane().add(lblCodCatProd, new org.netbeans.lib.awtextra.AbsoluteConstraints(1160, 80, -1, 40));

        txtId.setFont(new java.awt.Font("Roboto", 0, 18)); // NOI18N
        getContentPane().add(txtId, new org.netbeans.lib.awtextra.AbsoluteConstraints(1300, 80, 60, 30));

        jLabel15.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        jLabel15.setText("Buscar por medida:");
    ...
    private void fldMeasureActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fldMeasureActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_fldMeasureActionPerformed
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        else
        {
            ...
            String measures = (String)jTable1.getValueAt(fila, 1);
            
            txtId.setText(""+id);
            fldMeasure.setText(measures);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmMeasuresProd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmMeasuresProd().setVisible(true);
            }
        });
    }

    private void addCamps(){
        campos.add(fldMeasure.getText());
    }
    
    private void clear(){
        txtId.setText(null);
        fldMeasure.setText(null);
    }
    ...
    private javax.swing.JTextField fldMeasure;
